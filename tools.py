...
#     try:
#         search = tmdb.Search()
#         # Note: tmdbsimple methods like search.movie() and movie.info() are synchronous calls
...
#         # Construct a human-readable summary string from the movie object's attributes
...
#         # Catch network-related errors (if requests is used implicitly by tmdb)
#         return f"A network error occurred while contacting TMDB: {e}"
#     except Exception as e:
#         return f"An unexpected error occurred: {e}"

# # --- Tool 2: Custom Agent-Based Tool (Poetry Agent) ---
# # This remains the same, as it's an Agent and will be wrapped as a tool.
# poetry_agent = Agent(
#     name="poetry_agent",
